...
# Purpose: Streamlit application deployment
...
cat > "${WORK_DIR}/app.py" <<'ONYXIA_FILE_555df8209d47'
import streamlit as st

st.title('My Streamlit App')
st.write('Hello, World!')
ONYXIA_FILE_555df8209d47
mkdir -p "$(dirname "${WORK_DIR}/requirements.txt")"
cat > "${WORK_DIR}/requirements.txt" <<'ONYXIA_FILE_3a8729c19f22'
streamlit
ONYXIA_FILE_3a8729c19f22
