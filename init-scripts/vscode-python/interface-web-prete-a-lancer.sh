...
# Purpose: interface web prete a lancer
...
cat > "${WORK_DIR}/app.py" <<'ONYXIA_FILE_0b83d2968b36'
import streamlit as st
st.title('Interface Web')
st.write('Bonjour, cette interface est accessible depuis l’extérieur.')
ONYXIA_FILE_0b83d2968b36
