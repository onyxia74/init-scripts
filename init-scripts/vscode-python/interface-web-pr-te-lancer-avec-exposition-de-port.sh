...
# Purpose: interface web prête à lancer avec exposition de port
...
cat > "${WORK_DIR}/app.py" <<'ONYXIA_FILE_b88f9421d7d4'
import streamlit as st

st.title('Mon Application Web')
st.write('Bonjour, cette application est prête à être exposée sur un port.')

if st.button('Cliquez-moi !'):
    st.success('Vous avez cliqué !')
ONYXIA_FILE_b88f9421d7d4
