...
# Purpose: déploiement d'une API Python
...
cat > "${WORK_DIR}/main.py" <<'ONYXIA_FILE_40336a6cde46'
...
cat > "${WORK_DIR}/onyxia/run.sh" <<'ONYXIA_FILE_f5bf3534a6d5'
#!/usr/bin/env bash
set -euo pipefail
cd "${WORK_DIR}"
uvicorn main:app --host 0.0.0.0 --port 8000
ONYXIA_FILE_f5bf3534a6d5
