...
# Purpose: ready-to-run FastAPI application
...
cat > "${WORK_DIR}/app.py" <<'ONYXIA_FILE_f12eec5684f1'
...
cat > "${WORK_DIR}/onyxia/run.sh" <<'ONYXIA_FILE_a5c5a39202c7'
#!/usr/bin/env bash
set -euo pipefail
cd "${WORK_DIR}"
uvicorn app:app --host 0.0.0.0 --port "${PORT:-8000}"
ONYXIA_FILE_a5c5a39202c7
