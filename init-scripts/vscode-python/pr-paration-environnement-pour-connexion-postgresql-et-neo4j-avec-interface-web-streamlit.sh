...
# Purpose: préparation environnement pour connexion PostgreSQL et Neo4j avec interface web Streamlit
...
"${PYTHON_BIN}" -m pip install pandas sqlalchemy psycopg2-binary py2neo streamlit
