...
# Purpose: web interface skeleton
...
cat > "${WORK_DIR}/app.py" <<'ONYXIA_FILE_4ac041e13307'
import streamlit as st
st.title('My Web Interface')
st.write('Connected to PostgreSQL and Neo4j')
ONYXIA_FILE_4ac041e13307
