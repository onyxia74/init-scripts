...
# Purpose: interface web prête à lancer avec Streamlit
...
cat > "${WORK_DIR}/app.py" <<'ONYXIA_FILE_e181b47d3476'
import streamlit as st

st.title('Application Streamlit')
st.write('Bonjour, bienvenue sur votre application Streamlit !')
ONYXIA_FILE_e181b47d3476
